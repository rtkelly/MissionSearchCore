...
namespace MissionSearch.Indexers
{
    ...
    public interface IContentIndexer<T>  where T : ISearchDocument 
    {
        ...
        //IndexResults RunFullIndex(IEnumerable<ISearchableContent> contentItems);
        //IndexResults RunFullIndex(IEnumerable<ISearchableContent> contentItems, Global<T>.StatusCallBack statusCallback, Global<T>.IndexCallBack indexerCallback);
        ...
        //T Update(ISearchableContent contentItem);
